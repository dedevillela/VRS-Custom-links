# VRS-Custom-links 🛩️ [![MIT License](https://img.shields.io/badge/License-MIT-red.svg)](LICENSE) [![VRS version 2.4](https://img.shields.io/badge/VRS-v2.4-blue.svg)](http://virtualradarserver.co.uk/Download.aspx) [![Build Status](https://travis-ci.org/dedevillela/VRS-Custom-links.svg?branch=master)](https://travis-ci.org/dedevillela/VRS-Custom-links)  [![GitHub release](https://img.shields.io/github/release/dedevillela/VRS-Custom-links.svg)](https://github.com/dedevillela/VRS-Custom-links/releases) [![bitHound Code](https://www.bithound.io/github/dedevillela/VRS-Custom-links/badges/code.svg)](https://www.bithound.io/github/dedevillela/VRS-Custom-links) [![bitHound Overall Score](https://www.bithound.io/github/dedevillela/VRS-Custom-links/badges/score.svg)](https://www.bithound.io/github/dedevillela/VRS-Custom-links)
